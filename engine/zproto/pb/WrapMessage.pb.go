...
type WrapMessage struct {
	...
	Cmd      int32  `protobuf:"varint,1,opt,name=cmd,proto3" json:"cmd,omitempty"`           // 协议编号
	Content  []byte `protobuf:"bytes,2,opt,name=content,proto3" json:"content,omitempty"`    // 协议二进制
	Request  int32  `protobuf:"varint,3,opt,name=request,proto3" json:"request,omitempty"`   //请求码
	Response int32  `protobuf:"varint,4,opt,name=response,proto3" json:"response,omitempty"` //响应码
	Code     int32  `protobuf:"varint,5,opt,name=code,proto3" json:"code,omitempty"`         //返回码
}
...
func (x *WrapMessage) GetCmd() int32 {
	if x != nil {
		return x.Cmd
	}
	return 0
...
var file_WrapMessage_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x63, 0x6d, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a,
	...
	0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x42, 0x06, 0x5a,

...
type WrapMessage struct {
	...
	Cmd      uint32 `protobuf:"varint,1,opt,name=cmd,proto3" json:"cmd,omitempty"`           // 协议编号
	Content  []byte `protobuf:"bytes,2,opt,name=content,proto3" json:"content,omitempty"`    // 协议二进制
	Request  uint32 `protobuf:"varint,3,opt,name=request,proto3" json:"request,omitempty"`   //请求码
	Response uint32 `protobuf:"varint,4,opt,name=response,proto3" json:"response,omitempty"` //响应码
	Code     uint32 `protobuf:"varint,5,opt,name=code,proto3" json:"code,omitempty"`         //返回码
}
...
func (x *WrapMessage) GetCmd() uint32 {
	if x != nil {
		return x.Cmd
	}
	return 0
...
var file_WrapMessage_proto_rawDesc = []byte{
	...
	,
